	...
	\label{subsec:eigentraegheitsmoment}
		...
		\label{subsec:versch_momente}
				...
				\begin{table}[h!]
					\begin{center}
						...
						\begin{tabular}{|c||c||c|}
							...
							\hline 
							\hline
							\input{data/messung4_holzkugel.tex}
							\hline 
						\end{tabular}
					\end{center}
				\end{table}
			...
			\label{subsubsec:holzkugel}
				\begin{figure}[htbp]
					\begin{minipage}[t]{8cm}
						...
						\begin{eqnarray}
							I_\mathrm{2, theorie} & = & \frac{1}{2}mr^2 \,, \label{eqn:zylinder} \\
				...
				\begin{table}[h!]
					\begin{center}
						...
						\begin{tabular}{|c||c||c|}
							...
							\hline 
							\hline
							\input{data/messung3_messingzylinder.tex}
							\hline 
						\end{tabular}
					\end{center}
				\end{table}
			...
			\label{subsubsec:puppe}
				...
				Die Messdaten liefern mit Gleichung \eqref{eqn:schwingungsdauer} die Ergebnisse
