...
\label{sec:theorie}
	...
	\begin{equation}
		n^2(\lambda) = 1 + \frac{N_\mathrm{1} {q_\mathrm{1}}^2 {\lambda_\mathrm{1}}^2}{4 \pi^2 c^2 \epsilon_\mathrm{0}^2 m_\mathrm{1}} \left( 1 + (\frac{\lambda_\mathrm{1}}{\lambda})^2 + (\frac{\lambda_\mathrm{1}}{\lambda})^4+ \cdot \cdot \cdot \right) \label{eqn:dispersion1exakt}
	\end{equation}
